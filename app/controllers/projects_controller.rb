class ProjectsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @project.update(project_params)
        format.html { redirect_to @project, notice: 'Proyecto Actualizado correctamente' }
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:name, :description, :currentStatus, :finishDate, :active, :category_id)
    end
end
